...
urlpatterns = patterns('',
    ...
    url(r'^list/(?P<format>\w+)/$', 'ispdb.config.views.list',
        name='ispdb_list'),
    url(r'^list/$', 'ispdb.config.views.list', name='ispdb_list'),
    url(r'^details/(?P<id>\d+)/$', 'ispdb.config.views.details',
        name='ispdb_details'),
    ...
    url(r'^approve/(?P<id>\d+)/$', 'ispdb.config.views.approve',
        name='ispdb_approve'),
    url(r'^delete/(?P<id>\d+)/$', 'ispdb.config.views.delete',
        name='ispdb_delete'),
    url(r'^report/(?P<id>\d+)/$', 'ispdb.config.views.report',
        name='ispdb_report'),
    url(r'^show_issue/(?P<id>\d+)/$', 'ispdb.config.views.show_issue',
        name='ispdb_show_issue'),
    url(r'^sanity/(?P<id>\d+)/$', 'ispdb.config.views.sanity',
        name='ispdb_sanity'),
)
